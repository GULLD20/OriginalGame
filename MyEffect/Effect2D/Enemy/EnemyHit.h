...
public:
	...
	void SetMainPos(DirectX::SimpleMath::Vector3 pos) { m_mainPos = pos; }
	void SetMainRotation(DirectX::SimpleMath::Matrix rotation) { m_mainRotation = rotation; }
...
private:
	...
	//追加
	//このクラスを呼び出す対象が持っているマトリックス
	DirectX::SimpleMath::Vector3                                                  m_scale;
	DirectX::SimpleMath::Vector3                                                  m_mainPos;
	DirectX::SimpleMath::Matrix                                                   m_mainRotation;

...
public:
	...
	void SetPos(const DirectX::SimpleMath::Vector3 &pos) { m_centerPosition = pos; }
	void SetMainMatrix(const DirectX::SimpleMath::Matrix &main) { m_mainMatrix = main; }
	void SetScale(const DirectX::SimpleMath::Vector3 &scale) { m_scale = scale; }
	void SetTimming(float timming) { m_timming = timming; }
private:
	...
	//追加
	//このクラスを呼び出した対象が持っているマトリックス
	DirectX::SimpleMath::Matrix                                                   m_mainMatrix;

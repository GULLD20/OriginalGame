...
public:
	...
	void SetPos(DirectX::SimpleMath::Vector3 pos) { m_centerPosition = pos; }
	void SetMainMatrix(DirectX::SimpleMath::Matrix main) { m_mainMatrix = main; }
